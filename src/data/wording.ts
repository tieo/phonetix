...
export const ROWS: Record<string, Words> = {
  ...
  "rest": { name: "Where it waits", about: "the corner the mark sits in, and the point the circle is carried away from" },
...
export const SAYS: Record<string, string> = {
  ...
  "remove": "Remove",
  "rest-pin": "Put it somewhere of your own",
  "rest-pinned": "Where you put it",
  "rest-put": "Drag the mark where you want it",
  "rest-side": "On the side it rests, down by the hand",
  "say-into": "Answer in",
