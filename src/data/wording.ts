...
export const ROWS: Record<string, Words> = {
  ...
  "rest": { name: "Where it waits", about: "and the point the circle is carried away from, so your hand is never over the word" },
...
export const SAYS: Record<string, string> = {
  ...
  "remove": "Remove",
  "rest-edge": "Rests on the %s",
  "rest-own": "Where you put it",
  "rest-put": "Drop it at an edge to let it rest there, or anywhere to keep it there",
  "say-into": "Answer in",
