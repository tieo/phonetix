...
export const ROWS: Record<string, Words> = {
  ...
  "rest": { name: "Where the button sits", about: "the corner it waits in when you are not using it" },
  ...
  "side": { name: "Which side", about: "which side of the screen the button sits on" },
...
export const SAYS: Record<string, string> = {
  ...
  "remove": "Remove",
  "rest-edge": "On the %s",
  "rest-own": "Where you put it",
  "rest-put": "Tap or drag to move the button. Put it against a side and it stays there.",
  "say-into": "Answer in",
