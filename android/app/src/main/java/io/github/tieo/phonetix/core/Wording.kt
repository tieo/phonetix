...
object Wording {
    ...
    /** Show over a word. */
    val layer = listOf(
        Choice("off", "Nothing", "the page as it is; a card when you stop on a word"),
        Choice("gloss", "What it means", "the meaning, above the word"),
        Choice("ipa", "How it is said", "the pronunciation, above the word"),
        Choice("gloss+ipa", "Both", "the meaning and the pronunciation, above the word"),
        Choice("replace", "In place of the word", "the word itself swapped for what it means; rest on it to see the word"),
    )
