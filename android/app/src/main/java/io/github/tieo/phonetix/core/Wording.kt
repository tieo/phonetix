...
object Wording {
    ...
    val rows = mapOf(
        ...
        "rest" to Words("Where the button sits", "the corner it waits in when you are not using it"),
    ...
    val says = mapOf(
        ...
        "rest-own" to "Where you put it",
        "rest-put" to "Tap or drag to move the button. Put it against a side and it stays there.",
