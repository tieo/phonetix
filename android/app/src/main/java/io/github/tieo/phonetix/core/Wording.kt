...
object Wording {
    ...
    val rows = mapOf(
        ...
        "rest" to Words("Where it waits", "and the point the circle is carried away from, so your hand is never over the word"),
    ...
    val says = mapOf(
        ...
        "remove" to "Remove",
        "rest-edge" to "Rests on the %s",
        "rest-own" to "Where you put it",
        "rest-put" to "Drop it at an edge to let it rest there, or anywhere to keep it there",
